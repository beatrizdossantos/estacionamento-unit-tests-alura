    ...
    public class Veiculo
    {
        ...
        public string Placa
        {
            ...
            set
            {
                ...
                for (int i = 4; i < 8; i++)
                {
                    if (!char.IsDigit(value[i]))
                    {
                        throw new FormatException("Do 5º ao 8º caractere deve-se ter apenas números!");
                    }
                }
                _placa = value;
        ...
        public string Proprietario
        {
            ...
            set
            {
                if (value.Length < 3)
                {
                    throw new FormatException("O Nome do proprietário deve ter ao menos 3 caracteres");
                }
                _proprietario = value;
            }
